# Project 4 - *instaBrowser*

**instaBrowser** is a photo sharing app using Parse as its backend.
...
- Added some layout features for the first controllers
...
1. Having two types of connecting segues and how to manage that with identifiers

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/G63NPlK.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
